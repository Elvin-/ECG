...
(function() {
    ...
    var t, x = document,
        ...
        Ya, Za, Ib = {},
        tb = 0,
        cb, L, bb, va, ub, B, oa, sa = function() {
            return t
        },
        W = [],
        $a = 0,
        ...
        Ob = /^[0-9]+$/,
        Pb = "stroke-width",
        db, Ra, ob, pb, qb, Wa, eb, fb, Bb, Cb, rb, Db, Eb, J = {},
        S;
    ...
    G.prototype["stroke-widthSetter"] = G.prototype.strokeSetter = function(a, b, c) {
        ...
        if (this.stroke && this["stroke-width"]) this.strokeWidth = this["stroke-width"],
            G.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0;
    ...
    ta.prototype = {
        ...
        getStyle: function(a) {
            return this.style = r({
                fontFamily: '"Microsoft YaHei","Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif',
                fontSize: "12px"
            }, a)
        },
        isHidden: function() {
        ...
        var ha = {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient") c =
                            m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, D = 'angle="' + (90 - V.atan((m - a) / (n - c)) * 180 / na) + '"', t();
                        else {
                            var j = m.r,
                                r = j * 2,
                                v = j * 2,
    ...
    ma.prototype = {
        ...
        defaultLabelFormatter: function() {
            ...
            if (h) g = Ia(h, this);
                ...
                for (; f-- && g === t;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Ga(b / c, -1) + e[f]);
        ...
        setTickPositions: function(a) {
            ...
            if (!I && !b.axisPointRange && !b.usePercentage && !j && s(b.min) && s(b.max) && (c = b.max - b.min)) {
                if (!s(d.min) &&
                    !s(b.userMin) && m && (b.dataMin < 0 || !b.ignoreMinPadding)) b.min -= c * m;
        ...
        getLinePath: function(a) {
            ...
            return b.renderer.crispLine(["M", e ?
                this.left : f, e ? d : this.top, "L", e ? b.chartWidth - this.right : f, e ? d : b.chartHeight - this.bottom
            ], a)
        },
        ...
        render: function() {
            ...
            if (I) b = a.getLinePath(I), a.axisLine ? a.axisLine.animate({
                d: b
    ...
    Va.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                ...
                i = c.length;
                for (j = 0; j < i; j++)
                    if (c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip && c[j].singularTooltips !== !0 && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series) e._dist = Q(l - e.clientX), k = C(k, e._dist), f.push(e);
        ...
        drag: function(a) {
            ...
            if (this.hasDragged > 10) {
                ...
                this.selectionMarker &&
                    g && (d = e - n, this.selectionMarker.attr({
                        height: Q(d),
                        y: (d > 0 ? 0 : d) + n
                    }));
        ...
        drop: function(a) {
            ...
            if (this.selectionMarker) {
                ...
                if (this.hasDragged || c) q(b.axes, function(b) {
                    if (b.zoomEnabled) {
                        var c = b.horiz,
                            e = a.type === "touchend" ? b.minPixelPadding :
                            0,
                            n = b.toValue((c ? f : g) + e),
    ...
    if (H.PointerEvent || H.MSPointerEvent) {
        ...
        Ma(Va.prototype, "init", function(a, b, c) {
            a.call(this, b, c);
            (this.hasZoom || this.followTouchMove) && A(b.container, {
                "-ms-touch-action": P,
                "touch-action": P
            })
        });
    ...
    Xa.prototype = {
        ...
        drawChartBox: function() {
            ...
            if (k) f ?
                f.animate(u) : this.plotBackground = b.rect(o, p, q, r, 0).attr({
                    fill: k
    ...
    O.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData) q(a, function(a, b) {
                ...
                if (o && h > o) {
                    ...
                    if (ia(k)) {
                        ...
                        if (s)
                            for (c = 0; c < h; c++) i = a[c], r[c] = i[0], u[c] = i.slice(1, s + 1);
                        else
                            for (c = 0; c < h; c++) i = a[c], r[c] = i[0], u[c] = i[1];
                    else oa(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== t && (i = {
        ...
        processData: function(a) {
            ...
            if (l && this.sorted && (!j || d > j || this.forceCrop))
                if (m =
                    h.getExtremes(), n = m.min, m = m.max, b[d - 1] < n || b[0] > m) b = [], c = [];
                else if (b[0] < n || b[d - 1] > m) e = this.cropData(this.xData, this.yData, n, m), b = e.xData, c = e.yData, e = e.start, f = !0, k = b.length;
        ...
        generatePoints: function() {
            ...
            if (b && (g !== (c = b.length) || j))
                for (m = 0; m < c; m++)
                    if (m === h && !j && (m += g), b[m]) b[m].destroyElements(), b[m].plotX = t;
            this.data = b;
            this.points = l
        },
        getExtremes: function(a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++)
                if (j = c[l], k = a[l], i = k !== null && k !== t && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g &&
                    (c[l - 1] || j) <= h, i && j)
                    if (i = k.length)
        ...
        animate: function(a) {
            ...
            a ? (a = b[g], d = b[g + "m"], a || (b[g] = a = c.clipRect(r(e, {
                    width: 0
                })), b[g + "m"] = d = c.clipRect(-99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight)), this.group.clip(a), this.markerGroup.clip(d), this.sharedClipKey =
                g) : ((a = b[g]) && a.animate({
                width: b.plotSizeX
        ...
        drawPoints: function() {
            ...
            if (d.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = U(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = o && i.enabled === t || i.enabled, m = c.isInsidePlot(v(d), e, c.inverted), a && e !== t && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = p(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[m ? "show" : "hide"](!0).animate(r({
                            x: d -
                                h,
                            y: e - h
                        }, k.symbolName ? {
    ...
    ha = la(O, {
        ...
        translate: function() {
            var a = this,
                ...
                c = a.options,
                d = a.borderWidth =
                p(c.borderWidth, a.activePointCount > 0.5 * a.xAxis.len ? 0 : 1),
                e = a.yAxis,
    ...
    O.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(h, v(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g))) d = r({
            ...
            align: c.align
        }) : (b.align(c, null, d), g = b.alignAttr, p(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) : p(c.crop, !0) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x +
        ...
        function() {
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                        ...
                        if (m > 0) {
                            ...
                            for (y = 0; y < L; y++) {
                                ...
                                if (G < y && H[y] !== null) G = y;
                                    ...
                                    for (w < L - y + G && H[y] !== null && (G = w - L + y); H[G] === null;) G++;
                                M.push({
                                    i: G,
                                    y: H[G]
                                });
                ...
                if (Ba(R) === 0 || this.verifyDataLabelOverflow(R)) this.placeDataLabels(), s && g && q(this.points, function(b) {
                    j = b.connector;
                    x = b.labelPos;
                    if ((t = b.dataLabel) && t._pos) K = t._attr.visibility, B = t.connX, A = t.connY, k = l ? ["M", B + (x[6] === "left" ? 5 : -5), A, "C", B, A, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", B + (x[6] === "left" ? 5 : -5), A, "L", x[2], x[3], "L", x[4], x[5]], j ? (j.animate({
                        d: k
